...
world_arch = [FTri 0.115 (GL.Color3 1 0 1) (V3 1 0 0) (V3 0 1 0) (V3 0 0 1), FTri 0.117 (GL.Color3 0 1 1) (V3 0 1 0) (V3 1 0 0) (normalize (V3 0.5 0.5 (-0.5)))] ++ stairs
...
stairs = concat
    [   let p0 = normalize (V3 (cos (t0 * r)) (sin (t0 * r)) (-zw / 2))
        ...
        in
        [FTri (t0 * pi) (GL.Color3 0.7 0.5 0.2) p0 p1 p2, FTri (t0 * pi) (GL.Color3 0.7 0.5 0.2) p0 p2 p3]
...
draw_ft (FTri height color a b c) =
    ...
    where
        side_segments = maximum [f a b, f b c, f c a] where f x y = round (1 * sin height * norm (a @- b) / player_height)
